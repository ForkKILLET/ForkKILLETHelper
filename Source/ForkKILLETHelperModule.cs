...
public class ForkKILLETHelperModule : EverestModule {
    ...
    public override Type SaveDataType => typeof(ForkKILLETHelperModuleSaveData);
    public static ForkKILLETHelperModuleSaveData SaveData => (ForkKILLETHelperModuleSaveData) Instance._SaveData;
